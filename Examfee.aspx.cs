...
namespace School_Management_System
{
    public partial class Examfee : System.Web.UI.Page
    {
        ...
        {
            da.SelectCommand = new OleDbCommand("select * from examfee where regno='" + regno_txtbx.Text + "'", feecon);
            ds.Clear();
            da.Fill(ds);
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    sts_lbl.Text = "The Student Already Paid the School Fee";
                }
        ...
        protected void pay_btn_Click(object sender, EventArgs e)
        {
            ...
            feecon.Open();
            da.UpdateCommand = new OleDbCommand("update examfee set status='Paid' where regno='" + regno_txtbx.Text + "'", feecon);
